# Generated by Django 4.2.10 on 2024-09-05 12:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.CharField(choices=[('welcome', 'Welcome Message'), ('ad_posted', 'Ad Posted Thank You'), ('broadcast', 'Broadcast'), ('custom', 'Custom')], default='custom', max_length=50)),
                ('message', models.TextField(verbose_name='Message content')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
